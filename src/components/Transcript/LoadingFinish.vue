    ...
    <div class="flex items-center">
        ...
        >
            <li class="flex items-center text-lg">
                <svg class="w-6 h-6 me-2 text-teal-500 dark:text-teal-400 shrink-0" aria-hidden="true" xmlns="http://www.w3.org/2000/svg" fill="currentColor" viewBox="0 0 20 20">
            ...
            <li class="flex items-center text-lg">
                ...
                Gerando insights médicos em instantes…
            </li>
        </ul>
    </div>
</template>
