<template>
    <div>
        ...
        <p class="text-md text-gray-600 text-center mt-4 dark:text-gray-300">
            Don’t have an account? <a @click="handleIsRegister" class="text-primary hover:underline cursor-pointer">Sign up</a>
        </p>
    </div>
</template>

<script setup>
const emits = defineEmits(['isRegister']);

const handleIsRegister = () => {
    emits('isRegister', true);
};
</script>
